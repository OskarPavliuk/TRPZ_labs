...
function onMessageReceived(payload) {
    ...
    if (message && message.type === 'ERROR') {
    ...
    } else if (message && message.type === 'JOIN') {
    ...
    } else if (message && message.type === null && message.content === null && message.sender === null) {
        // Перевірка на повідомлення про помилку, якщо отримано `null` значення для type, content і sender
        messageElement.classList.add('error-message');
        ...
        // Додаємо повідомлення про помилку, якщо отримано невірний формат повідомлення
        messageElement.classList.add('error-message');
        messageElement.textContent = 'Invalid message format';
    }
